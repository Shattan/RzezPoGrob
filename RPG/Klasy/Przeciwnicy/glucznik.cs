...
{
    public class glucznik : Przeciwnik
    {
        public override int Sila { get { return 2; } }
        public override int Zrecznosc { get { return 8; } }
        ...
        {
            get { return "Goblin łucznik"; }
        }

        public override string ObrazekWalki
        {
            get { return "Resources/Grafiki postaci walczących/glucznik.png"; }
        }
