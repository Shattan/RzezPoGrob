...
{
    public class wilkolak: Przeciwnik
    {
        ...
        public override int Inteligencja { get { return 10; } }
        public override double Obrazenia { get { return 10; } }
        public override double Pancerz { get { return 10; } }
        ...
        {
            get { return "Resources/Grafiki postaci walczących/wilkolak.png"; }
        }
